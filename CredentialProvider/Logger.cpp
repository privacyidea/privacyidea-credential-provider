...
void Logger::log(std::string message, const char* file, int line, bool logInProduction)
{
	logS(message, file, line, logInProduction);
}

void Logger::log(std::wstring message, const char* file, int line, bool logInProduction)
{
